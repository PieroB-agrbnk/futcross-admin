...
def pagina_panel() -> None:
    ...
    theme.seccion("Intentos sin paquete valido", "ultimos 7 dias")
    bl = db.bloqueos(hoy - timedelta(days=7), hoy)
    if bl.empty:
        theme.vacio("Nadie forzo la puerta",
                    "Ningun alumno intento entrenar sin paquete al dia esta semana.")
    else:
        st.dataframe(
